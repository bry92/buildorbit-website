    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 to-slate-900 flex items-center justify-center px-6 pt-20">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">Join BuildOrbit</h1>
          <p className="text-slate-400">Get 10 free credits + 3-day trial</p>
        </div>

        <form onSubmit={handleSignUp} className="bg-slate-800/50 border border-slate-700 rounded-xl p-8 space-y-6">
          <div>
